...
2. What are the main components of [k8s Architecture](https://www.simform.com/blog/kubernetes-architecture/).
    ...
    - Controll node consists of following components
        4. kube-Control Mananger - It controll the mutilpe thing in masternode. This handles the different controller and keeps the cluster to stay in desired state by creating replicas to the cluster
