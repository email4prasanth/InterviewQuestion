...
2. What are the main components of [k8s Architecture](https://www.simform.com/blog/kubernetes-architecture/).
    ...
    - Controll node consists of following components
        ...
        3. kube Scheduler - when deploying a pod kube scheduler identifies the best worker node based on the performance requirements like CPU, MEMORY, affinity. This is possible because the etcd store the vital information to run smoothly.
