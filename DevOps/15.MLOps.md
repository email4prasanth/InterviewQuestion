...
#### How MLOps works
    ...
    - Model Training - Once data is prepared MLOps will train on different models and choose the best.
    - Model Deployment - Once best model is selected and use it in the real world and make the predictions or decision.
